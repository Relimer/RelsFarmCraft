...
public class SeedMakerBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    private static final VoxelShape SHAPE = VoxelShapes.combineAndSimplify(
            ...
            Block.createCuboidShape(4, 11, 4, 12, 16, 12),
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.SEED_MAKER, SeedMakerBlockEntity::tick);
    }
}
