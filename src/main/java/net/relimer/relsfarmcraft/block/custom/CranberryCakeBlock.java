...
public class CranberryCakeBlock
extends Block {
    public static final int MAX_BITES = 6;
    public static final IntProperty BITES = Properties.BITES;
    public static final int DEFAULT_COMPARATOR_OUTPUT = CranberryCakeBlock.getComparatorOutput(0);
    ...
    public CranberryCakeBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (world.isClient) {
            if (CranberryCakeBlock.tryEat(world, pos, state, player).isAccepted()) {
                return ActionResult.SUCCESS;
            }
        ...
        return CranberryCakeBlock.tryEat(world, pos, state, player);
    }
    ...
    public int getComparatorOutput(BlockState state, World world, BlockPos pos) {
        return CranberryCakeBlock.getComparatorOutput(state.get(BITES));
    }
