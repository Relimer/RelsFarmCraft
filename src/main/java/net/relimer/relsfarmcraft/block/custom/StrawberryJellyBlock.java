...
public class StrawberryJellyBlock
extends TransparentBlock {
    ...
    public StrawberryJellyBlock(Settings settings) {
        super(settings);
    }

    private static boolean hasStrawberryJellyBlockEffects(Entity entity) {
    ...
    private void addCollisionEffects(World world, Entity entity) {
        if (StrawberryJellyBlock.hasStrawberryJellyBlockEffects(entity)) {
    ...
    public static void addRegularParticles(Entity entity) {
        StrawberryJellyBlock.addParticles(entity, 5);
    }

    public static void addRichParticles(Entity entity) {
        StrawberryJellyBlock.addParticles(entity, 10);
    }
    ...
    private static void addParticles(Entity entity, int count) {
        ...
        BlockState blockState = ModBlocks.STRAWBERRY_JELLY_BLOCK.getDefaultState();
