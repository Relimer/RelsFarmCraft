...
public class CranberryJellyBlock
extends TransparentBlock {
    ...
    public CranberryJellyBlock(Settings settings) {
        super(settings);
    }

    private static boolean hasCranberryJellyBlockEffects(Entity entity) {
    ...
    private void addCollisionEffects(World world, Entity entity) {
        if (CranberryJellyBlock.hasCranberryJellyBlockEffects(entity)) {
    ...
    public static void addRegularParticles(Entity entity) {
        CranberryJellyBlock.addParticles(entity, 5);
    }

    public static void addRichParticles(Entity entity) {
        CranberryJellyBlock.addParticles(entity, 10);
    }
    ...
    private static void addParticles(Entity entity, int count) {
        ...
        BlockState blockState = ModBlocks.CRANBERRY_JELLY_BLOCK.getDefaultState();
