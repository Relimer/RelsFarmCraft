...
extends TransparentBlock {
    ...
    public GrapeJellyBlock(Settings settings) {
        super(settings);
    }

    private static boolean hasGrapeJellyBlockEffects(Entity entity) {
    ...
    private void addCollisionEffects(World world, Entity entity) {
        if (GrapeJellyBlock.hasGrapeJellyBlockEffects(entity)) {
    ...
    public static void addRegularParticles(Entity entity) {
        GrapeJellyBlock.addParticles(entity, 5);
    }

    public static void addRichParticles(Entity entity) {
        GrapeJellyBlock.addParticles(entity, 10);
    }
    ...
    private static void addParticles(Entity entity, int count) {
        ...
        BlockState blockState = ModBlocks.GRAPE_JELLY_BLOCK.getDefaultState();
