...
public class StrawberryCakeBlock
extends Block {
    public static final int MAX_BITES = 6;
    public static final IntProperty BITES = Properties.BITES;
    public static final int DEFAULT_COMPARATOR_OUTPUT = StrawberryCakeBlock.getComparatorOutput(0);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (world.isClient) {
            if (StrawberryCakeBlock.tryEat(world, pos, state, player).isAccepted()) {
                return ActionResult.SUCCESS;
            }
        ...
        return StrawberryCakeBlock.tryEat(world, pos, state, player);
    }
    ...
    public int getComparatorOutput(BlockState state, World world, BlockPos pos) {
        return StrawberryCakeBlock.getComparatorOutput(state.get(BITES));
    }
