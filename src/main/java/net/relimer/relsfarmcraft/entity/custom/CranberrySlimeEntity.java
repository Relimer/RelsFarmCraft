...
public class CranberrySlimeEntity
extends SlimeEntity {
    public CranberrySlimeEntity(EntityType<? extends SlimeEntity> entityType, World world) {
    ...
    protected ParticleEffect getParticles() {
        return new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.CRANBERRY_JELLY_BLOCK.getDefaultState());
    }
