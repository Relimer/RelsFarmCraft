...
extends SlimeEntity {
    public StrawberrySlimeEntity(EntityType<? extends SlimeEntity> entityType, World world) {
    ...
    protected ParticleEffect getParticles() {
        return new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.STRAWBERRY_JELLY_BLOCK.getDefaultState());
    }
