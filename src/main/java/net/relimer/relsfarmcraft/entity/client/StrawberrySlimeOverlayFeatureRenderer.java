...
public class StrawberrySlimeOverlayFeatureRenderer<T extends LivingEntity>
        extends FeatureRenderer<T, StrawberrySlimeEntityModel<T>> {
    private final EntityModel<T> model;

    public StrawberrySlimeOverlayFeatureRenderer(FeatureRendererContext<T, StrawberrySlimeEntityModel<T>> context, EntityModelLoader loader) {
        super(context);
        this.model = new StrawberrySlimeEntityModel<>(loader.getModelPart(EntityModelLayers.SLIME_OUTER));
    }
