...
public class GrapeSlimeOverlayFeatureRenderer<T extends LivingEntity>
        extends FeatureRenderer<T, GrapeSlimeEntityModel<T>> {
    private final EntityModel<T> model;

    public GrapeSlimeOverlayFeatureRenderer(FeatureRendererContext<T, GrapeSlimeEntityModel<T>> context, EntityModelLoader loader) {
        super(context);
        this.model = new GrapeSlimeEntityModel<>(loader.getModelPart(EntityModelLayers.SLIME_OUTER));
    }
