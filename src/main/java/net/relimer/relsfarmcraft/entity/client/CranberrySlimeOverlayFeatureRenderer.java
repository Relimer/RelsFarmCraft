...
public class CranberrySlimeOverlayFeatureRenderer<T extends LivingEntity>
        extends FeatureRenderer<T, CranberrySlimeEntityModel<T>> {
    private final EntityModel<T> model;

    public CranberrySlimeOverlayFeatureRenderer(FeatureRendererContext<T, CranberrySlimeEntityModel<T>> context, EntityModelLoader loader) {
        super(context);
        this.model = new CranberrySlimeEntityModel<>(loader.getModelPart(EntityModelLayers.SLIME_OUTER));
    }
